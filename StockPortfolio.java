...
public class StockPortfolio {
    ...
    private void addStockInfo(Stock stockAccount, int i) {
        ...
        stockAccount.setSharePrice(sc.nextInt());
    ...
    private void showStockInfo() {
        ...
        for (Stock stockAccount : list) {
            System.out.println("Enter " + i + " Stock Information");
            ...
            System.out.println("Total Value of Shares = " + (stockAccount.getNumOfShare()) * (stockAccount.getSharePrice()));
            i++;
        }
    }
